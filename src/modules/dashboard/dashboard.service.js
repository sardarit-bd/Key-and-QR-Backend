    ...
    buildAvailableCategories(categories, plan, isLimitReached) {
        return categories.map((category) => {
            ...
            return {
                ...
                iconType: category.iconType || null,
                iconUrl: category.iconUrl || null,
                color: category.color,
                count: category.quoteCount || 0,
                quoteCount: category.quoteCount || 0,
                isPremium,
                isLocked,
    ...
    buildOverviewCategories(categories, assignedQuotes, plan) {
        ...
        return categories.map((category) => {
            ...
            return {
                ...
                iconUrl: category.iconUrl || null,
                color: category.color,
                count: category.quoteCount ?? categoryMap[category.slug] ?? categoryMap[category.name] ?? 0,
                quoteCount: category.quoteCount ?? categoryMap[category.slug] ?? categoryMap[category.name] ?? 0,
                isPremium,
                isLocked,
                isAvailableToday: !isLocked,
            };
